...
export class ItemResponse<T extends ItemDefinition> extends ResourceResponse<T & Resource> {
    ...
    constructor(resource: T & Resource, headers: CosmosHeaders, statusCode: number, subsstatusCode: number, item: Item, cosmosDiagnostics: CosmosDiagnostics);
    readonly item: Item;
}
...
export class ResourceResponse<TResource> {
    constructor(resource: TResource | undefined, headers: CosmosHeaders_2, statusCode: StatusCode, substatus?: SubStatusCode, cosmosDiagnostics?: CosmosDiagnostics);
    // (undocumented)
    get activityId(): string;
    // (undocumented)
    readonly cosmosDiagnostics?: CosmosDiagnostics;
    // (undocumented)
    get etag(): string;
    // (undocumented)
